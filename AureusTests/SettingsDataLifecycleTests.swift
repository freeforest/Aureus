...
struct SettingsDataLifecycleTests {
    ...
    func explicitExternalExport() async throws {
        ...
        #expect(model.externalExportResultLabel == "External Backup export completed: schema 9, \(result.databaseByteCount) bytes.")
    ...
    func externalRestoreCapabilityAndInvocation() async throws {
        ...
        #expect(model.externalRestoreResult?.finalSchemaVersion == 9)
        ...
        #expect(model.externalRestoreResultLabel == "External Backup Restore completed: source schema 3, final schema 9, 4096 bytes.")
    }

    @Test("External Restore migration presentation covers every supported legacy schema", arguments: [1, 2, 3, 4, 5, 6, 7, 8])
    @MainActor
    func externalRestoreLegacyPresentation(schemaVersion: Int) async throws {
        ...
        #expect(model.externalRestoreResult?.migrationRan == true)
        #expect(model.externalRestoreResult?.operationCategory == .externalGenerationRestore)
        #expect(model.externalRestoreResultLabel == "External Backup Restore completed: source schema \(schemaVersion), final schema 9, 4096 bytes.")
    }
    ...
    func liveExternalRestoreLifecycle() async throws {
        ...
        #expect(model.externalRestoreResult?.sourceSchemaVersion == 9)
        #expect(model.externalRestoreResult?.finalSchemaVersion == 9)
