# Aureus documentation

## Using Aureus

- [Product overview](../README.md): wealth, portfolio analytics, and markets.
- [Download & installation](distribution.md): official assets, checksums, platform support, and signing limitations.
- [Privacy & Data](privacy-and-data.md): local records, credentials, session-only market data, and backups.
- [1.0.0 verification summary](evidence/release-1.0.0.md): what publication checks establish and what remains unverified.
...
No claim of a complete repository-history safety audit is made.
